    ...
    <div class="container">
        <div class="signup-content">
            <div class="signup-form">
                ...
                <div class="form-group">
                    <input type="text" name="username" id="username" value="<?= old('username'); ?>" placeholder="Masukan NPM" />
                ...
                <div class="form-group">
                    ...
                    <?php else : ?>
                        <small for="file_ktp" class="text-info">Upload Foto KTM | Maksimal 512 KB.</small>
                    <?php endif; ?>
                </div>
