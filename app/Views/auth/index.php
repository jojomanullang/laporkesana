    ...
    <div class="container">
        ...
        <div class="signin-content">
            <div class="signin-image">
                <figure><img src="<?php echo base_url() ?>/assets/img/portfolio/unika.jfif" alt="sing in image" width="100%" height="100%"></figure>
            </div>

            <?= form_open('/auth/validasi_login', ['class' => 'signin-form']); ?>
            <h3 class="form-title">APLIKASI LAPOR KEKERASAN SEKSUAL DAN NARKOBA</h3>
            ...
            <div class="form-group form-button text-center">
                <button type="submit" name="btn-submit" id="signin" class="btn btn-danger" >Log In</button>
            </div>
