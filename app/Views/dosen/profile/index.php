...
<style>
    .rounded-outline {
      border: 3px solid #000; /* Ganti #000 dengan warna outline yang diinginkan */
    }
</style>
            ...
            <div class="card shadow px-5 py-4">
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-12">
                        <img class="card-img-top p-2 rounded-circle card-img-top p-2 rounded-circle rounded-outline" src="/img/profile/<?= $data['user_image']; ?>" alt="Image profile" height="290">
                    </div>
                    <div class="col-lg-8 col-md-8 col-sm-12">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item"><span class="badge badge-info"> <?= ($data['user_level'] == 1 ? 'Admin' : ($data['user_level'] == 2 ? 'DOSEN' : 'MAHASISWA')); ?></span></li>
                            <li class="list-group-item"><i class="fa fa-user"></i>Nama : <?= $data['nama']; ?> </li>
                            <li class="list-group-item"><i class="fa fa-user"></i>NPM : <?= $data['username']; ?> </li>
                            <li class="list-group-item"><i class="fa fa-envelope"></i> BIDANG : <?= $data['email']; ?></li>
