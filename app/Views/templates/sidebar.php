<ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="">
        ...
        <div class="sidebar-brand-text mx-3">APLIKASI LAPOR KESANA</div>
    </a>
    ...
    <?php if (session()->get('user_level') == 3) : ?>
        <li class="nav-item <?= url_is('/pengaduan') || url_is('/pengaduan/tambah') ? 'active' : '' ?>">
            ...
            <div id="collapsTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <a class="collapse-item" href="/pengaduan">Daftar Laporan</a>
                    <a class="collapse-item" href="/pengaduan/tambah">Tambah Laporan Baru</a>
                </div>
            </div>
        </li>
    <?php endif; ?>
