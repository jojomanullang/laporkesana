        ...
        <div class="col-12">
            <div class="card shadow card-detail">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            <?php if ($data['status_pengaduan'] == 3) : ?>
                                <button type="button" class="btn btn-sm btn-primary disabled"><i class="fas fa-info-circle"></i> Laporan selesai </button>
                            <?php else : ?>
                    ...
                    <hr>
                    <div class="row">
                        <div class="col-md-3">Nama Pelapor</div>
                    ...
                    <hr>
                    <div class="row">
                        <div class="col-md-3">Status Laporan</div>
                        <div class="col-md-1 d-none d-md-block">:</div>
                        <div class="col-md-8">
                    ...
                    <hr>
                    <div class="row">
                        <div class="col-md-3">Tanggal Laporan</div>
                        <div class="col-md-1 d-none d-md-block">:</div>
                        <div class="col-md-8">
