    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <a href="/admin/manage-user">&laquo; Kembali ke daftar Pengguna</a>
                ...
                <div class="card mb-3 text-gray-900 p-2" style="max-width: 540px;">
                    <div class="row no-gutters">
                        ...
                        <div class="col-md-8">
                            <div class="card-body">
                                <h5 class="card-title"><b>NPM   : </b><?= $data['username']; ?></h5>
                                <hr class="sidebar-divider">
                                <p class="card-text mb-0"><b>Nama: </b><?= $data['nama']; ?></p>
                                <p class="card-text mb-0"><b>Email: </b><?= $data['email']; ?></p>
                                <hr class="sidebar-divider">
                                <p class="card-text mb-0"><b>File Identitas: </b><a href="/img/ktp/<?= $data['user_ktp']; ?>" target="_blank">Lihat</a></p>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <span class="text-gray-900">Klik "Verifikasi" untuk konfirmasi pengaktifan akun pengguna.</span>
                        <?= csrf_field(); ?>
